"use strict";
(self.webpackChunkbepag = self.webpackChunkbepag || []).push([
  [496],
  {
    496: function (n, e, t) {
      t.r(e),
      ...
      var r,
        ...
        p = function (n, e, t) {
          try {
            if (PerformanceObserver.supportedEntryTypes.includes(n)) {
              ...
              return (
                r.observe(Object.assign({ type: n, buffered: !0 }, t || {})), r
              );
            }
          } catch (n) {}
        },
        ...
        C = function (n) {
          "hidden" === document.visibilityState &&
            T > -1 &&
            ((T = "visibilitychange" === n.type ? n.timeStamp : 0), L());
        },
        E = function () {
        ...
        D = function (n, e) {
          r ||
            ((r = e), (i = n), (o = new Date()), x(removeEventListener), M());
        },
        M = function () {
          if (i >= 0 && i < o - k) {
            var n = {
              ...
              var t,
                ...
                c = function (n) {
                  n.startTime < o.firstHiddenTime &&
                    ((u.value = n.processingStart - n.startTime),
                    u.entries.push(n),
                    t(!0));
                },
                s = function (n) {
                ...
                d = p("first-input", s);
              (t = v(n, u, N, e.reportAllChanges)),
                d &&
                  h(
                    g(function () {
                      s(d.takeRecords()), d.disconnect();
                    })
                  ),
                d &&
                  f(function () {
        ...
        j = function (n) {
          n.forEach(function (n) {
            n.interactionId &&
              ((O = Math.min(O, n.interactionId)),
              (q = Math.max(q, n.interactionId)),
              (H = q ? (q - O) / 7 + 1 : 0));
          });
        },
        _ = function () {
          return u ? H : performance.interactionCount || 0;
        },
        z = function () {
        ...
        V = function (n) {
          var e = Q[Q.length - 1],
            t = U[n.interactionId];
          if (t || Q.length < 10 || n.duration > e.latency) {
            if (t)
              t.entries.push(n), (t.latency = Math.max(t.latency, n.duration));
            else {
              var r = {
                id: n.interactionId,
                latency: n.duration,
            ...
            Q.sort(function (n, e) {
              ...
              Q.splice(10).forEach(function (n) {
                delete U[n.id];
              });
          }
        },
            ...
            w(function () {
              ...
              var t,
                ...
                i = function (n) {
                  ...
                  var e,
                    i =
                      ((e = Math.min(Q.length - 1, Math.floor(K() / 50))),
                      Q[e]);
                  i &&
                    i.latency !== r.value &&
        ...
        Z = function (n, e) {
          (e = e || {}),
            w(function () {
              ...
              if (a) {
                t = v(n, i, X, e.reportAllChanges);
                var u = g(function () {
                  Y[i.id] ||
                    (o(a.takeRecords()), a.disconnect(), (Y[i.id] = !0), t(!0));
                });
                ["keydown", "click"].forEach(function (n) {
                  addEventListener(n, u, !0);
                }),
                  h(u),
                  f(function (r) {
                    (i = l("LCP")),
          ...
          nn(function () {
            ...
            if (i) {
              ...
              (t.value = Math.max(o - d(), 0)),
                ...
                r(!0),
                f(function () {
                  (t = l("TTFB", 0)), (r = v(n, t, $, e.reportAllChanges))(!0);
                });
            }
          });
        };
...
//# sourceMappingURL=496.83d5f5ab.chunk.js.map
